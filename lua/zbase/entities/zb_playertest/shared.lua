...
NPC.Name = "Player" -- Name of your NPC
NPC.Category = false -- Category in the ZBase tab
NPC.Weapons = {"weapon_ar2", "weapon_smg1", "weapon_shotgun", "weapon_357", "weapon_rpg", "weapon_crowbar", "weapon_crossbow", "weapon_stunstick", "weapon_pistol"} -- Example: {"weapon_rpg", "weapon_crowbar", "weapon_crossbow"}
