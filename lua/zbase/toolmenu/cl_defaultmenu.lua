...
ZBaseAddToolMenu( "ZBASE", "AI", function(panel)
    ...
    panel:ZBase_ToolMenuAddItem( { panel:NumSlider( "HP Mul", "zbase_hp_mult", 0, 20, 2 ) }, color_black, SettingFont, "", DescriptionColor, DescriptionFont )
    panel:ZBase_ToolMenuAddItem( { panel:NumSlider( "DMG Mul", "zbase_dmg_mult", 0, 20, 2 ) }, color_black, SettingFont, "", DescriptionColor, DescriptionFont )
