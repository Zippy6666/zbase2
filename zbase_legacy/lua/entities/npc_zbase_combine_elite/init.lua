...
-- General
ENT.Models = ZBASE_TBL({"models/Combine_Super_Soldier.mdl"}) -- Models to spawn with, add as many as you want
...
ENT.MeleeAttackDamage = 15 -- Melee attack damage
ENT.MeleeAttackDamageDelay = 0.5 -- Time until damage

ENT.WeaponProficiency = WEAPON_PROFICIENCY_PERFECT -- https://wiki.facepunch.com/gmod/Enums/WEAPON_PROFICIENCY
